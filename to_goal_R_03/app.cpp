...
void system_create()
{
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 2]     = new StraRun(StraRun::BEHIND, gControl[Control::TO_DOUBLE_SIZE + 2], gLeftMotor, gRightMotor, Run::MID);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 3]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 3], gLeftMotor, gRightMotor);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 5] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 5]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 5], gLeftMotor, gRightMotor);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 6]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 6], gLeftMotor, gRightMotor, Run::LOW);
    ...
    gRun[Scenario::TO_DOUBLE_SIZE + 7]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 7], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 8] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[Scenario::TO_DOUBLE_SIZE + 8]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 8], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 9] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 9]     = new StraRun(StraRun::BEHIND, gControl[Control::TO_DOUBLE_SIZE + 9], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 9]   = new RunDistJudge(gRunDistDetect);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 10] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 10]     = new RotateRun(RotateRun::LEFT, gControl[Control::TO_DOUBLE_SIZE + 10], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 10]   = new RotateAngleJudge(RotateAngleJudge::LEFT, gAngleMonitor);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 11] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 11]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 11], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 11]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：旋回角度に近づくたび減速する制御(P)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 12] = new GyroStopP(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 12]     = new RotateRun(RotateRun::RIGHT, gControl[Control::TO_DOUBLE_SIZE + 12], gLeftMotor, gRightMotor);
    gJudge[Scenario::TO_DOUBLE_SIZE + 12]   = new RotateAngleJudge(RotateAngleJudge::RIGHT, gAngleMonitor);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 13] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[Scenario::TO_DOUBLE_SIZE + 13]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 13], gLeftMotor, gRightMotor, Run::LOW);
    gJudge[Scenario::TO_DOUBLE_SIZE + 13]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 14] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 14]     = new StraRun(StraRun::FRONT, gControl[Control::TO_DOUBLE_SIZE + 14], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 14]   = new RunDistJudge(gRunDistDetect);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 15] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[Scenario::TO_DOUBLE_SIZE + 15]     = new LineTraceRun(LineTraceRun::RIGHT, gControl[Control::TO_LAP_SIZE + 15], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 15]   = new ColorJudge(gColorDetect);
     ...
     * 制御方法：まっすぐ走るための制御(PD)
     * ------------------------------------------------------------*/
    gControl[Control::TO_DOUBLE_SIZE + 16] = new GyroStraPD(gAngleMonitor);
    gRun[Scenario::TO_DOUBLE_SIZE + 16]     = new StraRun(StraRun::BEHIND, gControl[Control::TO_DOUBLE_SIZE + 16], gLeftMotor, gRightMotor, Run::MID);
    gJudge[Scenario::TO_DOUBLE_SIZE + 16]   = new RunDistJudge(gRunDistDetect);
    ...
    gToGoalScenario = new Scenario(gScene, 26, 37);
