...
void system_create()
{
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[1] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[1]     = new LineTraceRun(LineTraceRun::LEFT, gControl[1], gLeftMotor, gRightMotor, Run::MID);
     ...
     * 制御方法：ラインに沿って走行するための制御(PID)
     * ------------------------------------------------------------*/
    gControl[3] = new LineTracePID(gHSVMonitor, 40, 0.5, 0.025, 2);
    gRun[3]     = new LineTraceRun(LineTraceRun::LEFT, gControl[3], gLeftMotor, gRightMotor, Run::MID);
